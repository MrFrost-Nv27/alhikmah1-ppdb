          ...
          <v-row align="center" justify="center">
            ...
            <v-col cols="12" sm="8" class="white--text text-left">
              <h1 class="font-weight-light display-2 mb-2">
                Tentang Situs PPDB Al Hikmah 1
              </h1>
              <h1 class="font-weight-light">
                Situs PPDB Al Hikmah 1 adalah salah satu fitur digital yang
                tersedia di Al Hikmah 1. Situs ini digunakan untuk pendaftaran
                awal di Al Hikmah 1.
              </h1>
              <v-btn
                rounded
